...
{
    const actionsList = document.createElement('var');
    const actionsLine = document.createElement('var');
    actionsLine.textContent = actions;


    
    actionsList.appendChild(actionsLine);
...
const createMonsterBlock = (data) =>
{
    ...
    const actionLine = actionList('Actions', data.actions);

    holder.appendChild(name);
    holder.appendChild(statBlock);
    holder.appendChild(attrBlock);
    holder.appendChild(actionLine);
